USE [master]
GO
/****** Object:  Database [SMS]    Script Date: 2/17/2025 10:45:37 PM ******/
CREATE DATABASE [SMS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SMS', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\SMS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'SMS_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\SMS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [SMS] SET COMPATIBILITY_LEVEL = 160
GO
...
USE [SMS]
GO
/****** Object:  Table [dbo].[tbStudents]    Script Date: 2/17/2025 10:45:37 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[tbStudents](
 ...
 CONSTRAINT [PK_tbStudents] PRIMARY KEY CLUSTERED 
(
	[StudentID] ASC
...
GO
/****** Object:  Table [dbo].[tbUsers]    Script Date: 2/17/2025 10:45:37 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
